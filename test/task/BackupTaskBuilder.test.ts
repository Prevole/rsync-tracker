...
import BackupTaskBuilder from '../../src/task/BackupTaskBuilder';
...
describe('BackupTaskBuilder', () => {
  ...
  describe('constructor', () => {
    it('should create a builder', () => {
      const builder = new BackupTaskBuilder(rsyncTrackerConfig);
      expect((builder as any).config).to.equal(rsyncTrackerConfig);
    });
  });
  ...
  describe('build', () => {
    ...
    it('should create simple rsync tasks with dest folder creation', () => {
      const builder = new BackupTaskBuilder(rsyncTrackerConfigWithDestCreate);
      const tasks = builder.build();
    ...
    it('should create simple rsync tasks with dest folder creation over ssh', () => {
      const builder = new BackupTaskBuilder(rsyncTrackerConfigWithDestCreateAndSsh);
      const tasks = builder.build();
    ...
    it('should create backup rsync tasks', () => {
      ...
      const builder = new BackupTaskBuilder(rsyncTrackerConfigInBackupMode);
      const tasks = builder.build();
